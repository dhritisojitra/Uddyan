...
export default function ContactUs() {
  ...
  return (
    <div className="bg-[#FFFDEB] min-h-screen flex items-center justify-center px-16 py-16">
      <div className="max-w-8xl w-full bg-white rounded-2xl shadow-xl p-10 transition-all transform hover:scale-[1.02] hover:shadow-2xl duration-500 animate-pulse-once">
        ...
        <div className="space-y-6 text-gray-800">
          ...
          <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-yellow-100 transition-all duration-300 hover:translate-x-2 hover:shadow-md group animate-slide-in-left">
            ...
            <div>
              <h2 className="font-semibold text-lg group-hover:text-[#007FFF] transition-colors duration-300">Address</h2>
          ...
          <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-yellow-100 transition-all duration-300 hover:translate-x-2 hover:shadow-md group animate-slide-in-right">
            ...
            <div>
              <h2 className="font-semibold text-lg group-hover:text-[#007FFF] transition-colors duration-300">Contact</h2>
              <p className="text-gray-700 group-hover:text-gray-900 transition-colors duration-300">
          ...
          <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-yellow-100 transition-all duration-300 hover:translate-x-2 hover:shadow-md group animate-slide-in-left">
            ...
            <div>
              <h2 className="font-semibold text-lg group-hover:text-[#007FFF] transition-colors duration-300">Email</h2>
              <a
      ...
      <style jsx>{`
        @keyframes bounce-in { 0% { transform: translateY(-20px); opacity: 0; } 50% { transform: translateY(5px); } 100% { transform: translateY(0); opacity: 1; } }
        @keyframes slide-in-left { 0% { transform: translateX(-30px); opacity: 0; } 100% { transform: translateX(0); opacity: 1; } }
        @keyframes slide-in-right { 0% { transform: translateX(30px); opacity: 0; } 100% { transform: translateX(0); opacity: 1; } }
        @keyframes pulse-once { 0% { transform: scale(0.95); opacity: 0.8; } 100% { transform: scale(1); opacity: 1; } }
        ...
        .animate-slide-in-left:last-child { animation-delay: 0.6s; }
